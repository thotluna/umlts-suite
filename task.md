...
- [x] **DESIGN**: Enforzar interfaces puras en `InterfaceRule`. Se eliminó el soporte de modificadores para interfaces y se actualizó la documentación (`docs/engine-nodes.umlts`) para eliminar el uso de `*` (abstract) cumpliendo con el nuevo estándar arquitectónico.
