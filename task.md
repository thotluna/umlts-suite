...
- [x] **FIX**: Regresión en `InterfaceRule` que impedía parsear modificadores post-keyword (como `*` para abstract), causando errores en archivos con sintaxis UMLTS pura.
