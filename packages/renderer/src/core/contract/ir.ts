 ...
 * Definida en el Renderer como el Contrato de entrada.
 */
...
// Alias de compatibilidad para el renderer
export type IR = IRDiagram
export type IRRelType = IRRelationshipType | string
export type EngineVisibility = IRVisibility
