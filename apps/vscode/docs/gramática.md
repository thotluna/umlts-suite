...
relationship_item ::= relationship_type [abstract_opt] identifier
...
```ebnf
attribute_def  ::= identifier ":" [relationship_mark] [abstract_opt] type [multiplicity]
...
```ebnf
relationship_header ::= relationship_type [abstract_opt] identifier

relationship_def    ::= [abstract_opt] identifier multiplicity_opt relationship_type multiplicity_opt [abstract_opt] identifier
